...
const Login = () => {
  return (
    <div className='mt-24 w-full h-screen flex items-center justify-center px-4'>
        <div className="bg-[#151A28] shadow-2xl border border-[#33394C] rounded-2xl p-8 sm:p-12 w-full max-w-md">
            ...
            <form className='flex mt-8 flex-col gap-3 w-full'>
                ...
                <p className='text-sm text-gray-500 text-center sm:text-left'>New here ? <Link className='text-blue-800' to="/auth/signup">Sign Up</Link></p>
            </form>
        </div>
    </div>
  )
